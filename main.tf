...
module "acme_api_aws_alb" {
  source = "git::https://github.com/tinystacks/tinystacks-terraform-modules.git//aws/modules/alb"
...
module "acme_api_aws_ecs_service" {
  source = "git::https://github.com/tinystacks/tinystacks-terraform-modules.git//aws/modules/ecs_service"
